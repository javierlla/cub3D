...
/*   Updated: 2024/10/19 13:42:33 by uxmancis         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/* move_forward
*
*   1. Calculate new position: in decimals based on 2D Map's dimensions (index > decimal > pixel)
*   2. Get px position updated
*   3. Get map index updated
*   4. Satellite position must be updated as well
*
...
void	ft_events_init(t_data *data)
{
	...
	mlx_hook(data->mlx->win_ptr, 17, 0, (int (*)(void *))close_program, data->mlx); //javi's
